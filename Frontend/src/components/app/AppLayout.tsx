...
const NAV: NavItem[] = [
  ...
  { to: "/assets", label: "Asset Registry", icon: Boxes, roles: ["admin", "asset_manager", "dept_head", "employee"] },
  { to: "/allocations", label: "Allocations", icon: ArrowLeftRight, roles: ["admin", "asset_manager", "dept_head"] },
  { to: "/bookings", label: "Bookings", icon: CalendarCheck, roles: ["admin", "asset_manager", "dept_head", "employee"] },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex max-w-[1600px] gap-6 p-4 md:p-6">
        ...
        <aside
          className={cn(
            "neu fixed inset-y-4 left-4 z-40 flex w-64 flex-col p-5 transition-transform md:static md:inset-auto md:translate-x-0",
